...
import imgPhat from "../../../assets/images/faces/DSC_1305.JPG";
                  ...
                  {notifications.map((notification, index) => (
                    <Dropdown.Item
                      ...
                      <div className="d-flex align-items-start">
                        <div className="pe-2">
                          <span
                            className={`avatar avatar-md bg-${notification.avatarColor}-transparent avatar-rounded`}>
            ...
            <Dropdown className="header-element header-profile">
              <Dropdown.Toggle
                ...
                <div className="d-flex align-items-center">
                  ...
                  <div className="d-sm-block d-none">
                    <p className="fw-semibold mb-0 lh-1 fs-13">Phòng QLKT</p>
              ...
              <Dropdown.Menu
                ...
                <Dropdown.Item
                  ...
                  href={`${import.meta.env.BASE_URL}pages/todolist/`}>
                  <i className="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task
                  Manager
                </Dropdown.Item>
                <Dropdown.Item
                  className="d-flex"
                  href={`${import.meta.env.BASE_URL}pages/email/mailsettings/`}>
                ...
                <Dropdown.Item
                  className="d-flex"
                  href={`${import.meta.env.BASE_URL}pages/chat/`}>
