        ...
        <Col xl={6}>
          <Row>
              ...
              <Card className="custom-card">
                ...
                <Card.Body>
                  ...
                  <Select
                    isMulti
                    name="colors"
                    options={Multipleselectdata1}
                    className="basic-multi-select"
                    id="choices-multiple-default"
                    menuPlacement="auto"
                    classNamePrefix="Select2"
                    defaultValue={[Multipleselectdata1[0]]}
                  />
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Passing Through Options</Card.Title>
                </Card.Header>
              ...
              <Card className="custom-card">
                ...
                <Card.Body>
                  <Select
                    ...
                    options={Optionwithnosearch}
                    className="default basic-multi-select"
                    id="choices-single-no-search"
                    menuPlacement="auto"
                    classNamePrefix="Select2"
                    defaultValue={[Optionwithnosearch[5]]}
                  />
                </Card.Body>
              </Card>
            </Col>
        ...
        <Col xl={6}>
          <Row>
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Email Address Only</Card.Title>
                </Card.Header>
                <Card.Body>
                  <Form.Control
            ...
            <Col xl={12}>
              <Card className="custom-card">
                <Card.Header>
                  <Card.Title>Passing Unique Values</Card.Title>
                </Card.Header>
                <Card.Body className="passing-option">
                  <CreatableSelect
                    components={components}
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Default Select</Card.Title>
...
<option value="3">Three</option>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Disabled Select</Card.Title>
              <div className="prism-toggle">
                <Button
 ...
 <option value="3">Three</option>
        ...
        <Col xl={4}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Rounded Select</Card.Title>
              <div className="prism-toggle">
                <Button
 ...
 <option value="3">Three</option>
      ...
      <Row>
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Multiple Attribute Select</Card.Title>
              <div className="prism-toggle">
                <Button
 ...
 <option defaultValue="3">Three</option>
        ...
        <Col xl={6}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Using Size Attribute</Card.Title>
              <div className="prism-toggle">
                <Button
...
<option defaultValue="5">Five</option>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Select Sizes</Card.Title>
              <div className="prism-toggle">
                <Button
