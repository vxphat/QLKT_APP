    ...
    <Fragment>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Table With Pagination</Card.Title>
            </Card.Header>
            <Card.Body>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Table With Search</Card.Title>
            </Card.Header>
            <Card.Body>
              <div id="grid-search">
                <Grid
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Table Sorting</Card.Title>
            </Card.Header>
            <Card.Body>
              <div id="grid-sorting">
                <Grid
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Table Loading</Card.Title>
            </Card.Header>
            <Card.Body>
              <div id="grid-loading">
                <Grid
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Wide Table</Card.Title>
            </Card.Header>
            <Card.Body>
              <div id="grid-wide">
                <Grid
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Fixed Header</Card.Title>
            </Card.Header>
            <Card.Body>
      ...
      <Row>
        <Col xl={12}>
          <Card className="custom-card">
            <Card.Header>
              <Card.Title>Hidden Columns</Card.Title>
            </Card.Header>
            <Card.Body>
