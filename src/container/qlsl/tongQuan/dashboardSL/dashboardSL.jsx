      ...
      <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
          <p className="fw-semibold fs-18 mb-0">
            TỔNG QUẢN TÌNH HÌNH SẢN LƯỢNG
          </p>
          <span className="fs-semibold text-muted">
            Dữ liệu cập nhật đến 8:26PM 09/01/2026
          </span>
        </div>
          ...
          <Row>
              ...
              <Col xl={12}>
                <Card className="custom-card">
                  <Card.Header className="  justify-content-between">
                    <Card.Title>Top 5 CN sản lượng cao nhất</Card.Title>
                    <Dropdown>
                      <Dropdown.Toggle
                        variant=""
                        aria-label="anchor"
            ...
            <Col xl={8} className="col-xl-8">
              <Row>
                ...
                <Card className="custom-card">
                  <Card.Header className=" justify-content-between">
                    <Card.Title>Tiến độ thực hiện sản lượng tháng</Card.Title>
                    <Dropdown>
                      <Dropdown.Toggle
                        variant=""
            ...
            <Col xxl={12} xl={12}>
              <Row>
                <Col xxl={12} xl={6}>
                  <Card className="custom-card">
                    <Card.Header className=" justify-content-between">
                      <Card.Title>Cơ cấu loại mủ</Card.Title>
                      <Dropdown>
                        <Dropdown.Toggle
                          variant=""
                          aria-label="anchor"
