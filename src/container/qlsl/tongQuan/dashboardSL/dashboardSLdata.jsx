      ...
      series: [
        {
          name: "Kế hoạch",
          data: [
            2000, 2200, 0, 1500, 2000, 2854, 2900, 3000, 3110, 3200, 3400, 3500,
          ],
        },
        {
          name: "Thực hiện",
          data: [
            2100, 2250, 0, 1700, 2100, 3000, 3200, 3400, 3540, 3600, 3800, 4000,
          ],
        },
      ],
      options: {
...
export function Leadssource() {
  return (
    <Doughnut options={Option4} data={Data4} height="300px" width="100px" />
  );
}
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      options: {
        ...
        colors: ["rgb(132, 90, 223)", "rgb(35, 183, 229)", "rgb(245, 184, 73)"],
      },
    };
  }
