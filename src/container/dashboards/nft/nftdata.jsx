...
export class NFTStatistics extends Component {
    ...
    render() {
        return (
            <div>
                <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={325} />
            </div>
...
export const TrendingNFTs1 = [
    { id: 1, src: nftimage10, name: 'Kakasha Si', mail: '@sensei011', value: '0.45%', color: 'success', price: '1.75ETH' ,class:'up'},
    { id: 2, src: nftimage1, name: 'Oorichimaru lo', mail: '@ooro001', value: '0.24%', color: 'success', price: '1.15ETH',class:'up' },
    { id: 3, src: nftimage2, name: 'SakuraYM', mail: '@sakura903', value: '0.07%', color: 'danger', price: '1.58ETH',class:'down' },
    { id: 4, src: nftimage4, name: 'Sasuke Uchiha', mail: '@sasuke777', value: '1.34%', color: 'success', price: '1.19ETH',class:'up' },
    { id: 5, src: nftimage15, name: 'Naruto Uzumaki', mail: '@naruto111', value: '1.70%', color: 'success', price: '2.45ETH' ,class:'up'},
    { id: 6, src: nftimage16, name: 'Kazimo Aruke', mail: '@kazimo900', value: '1.21%', color: 'danger', price: '1.95ETH' ,class:'down'},
    { id: 7, src: nftimage6, name: 'Nagiro Ohinavo', mail: '@nagiro096', value: '0.99%', color: 'success', price: '1.12ETH' ,class:'up'},
];
