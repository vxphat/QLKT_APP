...
export function Leadssource() {
    return <Doughnut options={Option4} data={Data4} height='300px' width="100px" />;
}
...
export const Dealsstatistics = [
    { id: '1', src: face4, name: 'Mayor Kelly', role: 'Manufacture', mail: 'mayorkelly@gmail.com', location: 'Germany', date: 'Sep 15 - Oct 12, 2023', color: 'info-transparent', checked: '' },
    { id: '2', src: face15, name: 'Andrew Garfield', role: 'Development', mail: 'andrewgarfield@gmail.com', location: 'Canada', date: 'Apr 10 - Dec 12, 2023', color: 'primary-transparent', checked: 'defaultChecked' },
    { id: '3', src: face11, name: 'Simon Cowel', role: 'Service', mail: 'simoncowel234@gmail.com', location: 'Europe', date: 'Sep 15 - Oct 12, 2023', color: 'danger-transparent', checked: '' },
    { id: '4', src: face8, name: 'Mirinda Hers', role: 'Marketing', mail: 'mirindahers@gmail.com', location: 'USA', date: 'Apr 14 - Dec 14, 2023', color: 'warning-transparent', checked: 'defaultChecked' },
    { id: '5', src: face9, name: 'Jacob Smith', role: 'Social Plataform', mail: 'jacobsmith@gmail.com', location: 'Singapore', date: 'Feb 25 - Nov 25, 2023', color: 'success-transparent', checked: 'defaultChecked' },
];
