                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <div
                                ...
                                ><span className='custom-text'>Height</span> 25%
                                </div>
                                <div className="h-50 d-inline-block"
                                    style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)', padding: '10px' }}
                                ><span className='custom-text'>Height</span> 50%
                                </div>
                                <div className="h-75 d-inline-block"
                                    style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)', padding: '10px' }}
                                ><span className='custom-text'>Height</span> 75%
                                </div>
                                <div className="h-100 d-inline-block"
                                    style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)', padding: '10px' }}
                                ><span className='custom-text'>Height</span> 100%
                                </div>
                                <div className="h-auto d-inline-block"
                                    style={{ width: '120px', backgroundColor: 'rgba(0,0,255,.1)', padding: '10px' }}
                                ><span className='custom-text'>Height</span> auto
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
