                    ...
                    <div className="row justify-content-center align-items-center h-100">
                        <Col xxl={6} xl={7} lg={7} md={7} sm={8} className="col-12">
                            <div className="p-5">
                                ...
                                <p className="mb-3 text-muted op-7 fw-normal">Welcome back Phát !</p>
                                ...
                                <div className="row gy-3">
                                    ...
                                    <Col xl={12} className=" mb-3">
                                        <Form.Label htmlFor="signin-password" className="form-label text-default d-block">Password<Link to={`${import.meta.env.BASE_URL}authentication/resetpassword/resetcover`} className="float-end text-danger">Forget password ?</Link></Form.Label>
                                        <InputGroup>
