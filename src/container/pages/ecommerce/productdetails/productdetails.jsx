...
import { Card, Col, Collapse, ProgressBar, Row } from 'react-bootstrap';
...
import ecommerceimg25 from "../../../../assets/images/ecommerce/png/25.png";
import 'swiper/css';
                            ...
                            <div className="row gx-5">
                                    ...
                                    <Row>
                                        <Col xxl={12} xl={6} lg={6} md={6} sm={12} className="mb-md-5 mb-3">
                                            <Swiper
                                                ...
                                                modules={[FreeMode, Navigation, Thumbs, Autoplay]} className="mySwiper2 swiper swiper-preview swiper-preview-details bg-light" >
                                                <SwiperSlide>
                                                    <img className="img-fluid" src={ecommerceimg15} alt="img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <img className="img-fluid" src={ecommerceimg13} alt="img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <img className="img-fluid" src={ecommerceimg14} alt="img" />
                                                </SwiperSlide>
                                                <SwiperSlide>
                                                    <img className="img-fluid" src={ecommerceimg17} alt="img" />
                                                </SwiperSlide>
                                            </Swiper>
                                        ...
                                        <div className="col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12 d-md-block d-none">
                                            <p className="fs-15 fw-semibold mb-2">Similar Products :</p>
                                            <div className="table-responsive">
                                                <table className="table table-bordered text-nowrap">
                                                    <tbody>
                                                                ...
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        ...
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Omega watch series 3</p>
                                                                            <p className="mb-0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg17} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fs-14 fw-semibold similar-product-name text-truncate">Strap on watch(White)</p>
                                                                            <p className="mb-0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg18} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fw-semibold similar-product-name text-truncate">Orange watch series 3</p>
                                                                            <p className="mb-0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg19} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fw-semibold similar-product-name text-truncate">Omega watch special edition</p>
                                                                            <p className="mb-0">
                                                                                <span className="badge bg-success">3.8<i className="ri-star-s-fill ms-1"></i></span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg20} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fw-semibold similar-product-name text-truncate">Fassil smart watch(45mm)</p>
                                                                            <p className="mb-0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg21} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fw-semibold similar-product-name text-truncate">Electro viintage watch(40mm)</p>
                                                                            <p className="mb-0">
                                                                                <span className="badge bg-success">4.1<i className="ri-star-s-fill ms-1"></i></span>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Link to="#">
                                                                    <div className="d-flex align-items-top">
                                                                        <div className="similar-products-image me-2">
                                                                            <img src={ecommerceimg22} alt="" />
                                                                        </div>
                                                                        <div className="flex-fill">
                                                                            <p className="mb-1 fw-semibold similar-product-name text-truncate">Bolts smart watch(Amoled)</p>
                                                                            <p className="mb-0">
                                                        ...
                                                        <tr>
                                                            <td className="d-grid">
                                                                <button className="btn btn-primary-light">View All Products</button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <Col xxl={9} xl={12}>
                                    <Row className="row gx-5">
                                        <Col xl={8} className="mt-xxl-0 mt-3">
                                            <div>
                                                <p className="fs-18 fw-semibold mb-0">Orange Watch Series 4 (GPS + Cellular, 44mm) - Colored Aluminium Case with Multiple Featured Sports Band - Regular</p>
                                                <p className="fs-18 mb-4">
                                                    ...
                                                    <span className="fw-semibold text-muted ms-1">4.3<Link className="text-info" to="#">(2.4k Reviews)</Link></span>
                                                </p>
                                                <div className="row mb-4">
                                                    <Col xxl={3} xl={12}>
                                                        <p className="mb-1 lh-1 fs-11 text-success fw-semibold">Special Offer</p>
                                                        <p className="mb-1"><span className="h3"><sup className="fs-14">$</sup>1,299<sup className="fs-14">.00</sup></span><span className="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                                        <p className="mb-0 text-muted fs-12">M.R.P-<s>$2,599.00</s></p>
                                                    </Col>
                                                    <Col xxl={4} xl={6} lg={6} md={6} sm={12} className="mt-xxl-0 mt-3">
                                                        <p className="mb-2 fs-15 fw-semibold">Watch Type</p>
                                                        <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                            <input type="radio" className="btn-check" name="select-type" id="type1" defaultChecked />
                                                            <label className="btn btn-sm btn-outline-light text-default" htmlFor="type1">GPS</label>
                                                            <input type="radio" className="btn-check" name="select-type" id="type2" />
                                                            <label className="btn btn-sm btn-outline-light text-default" htmlFor="type2">GPS+Cellular</label>
                                                        </div>
                                                    </Col>
                                                    <Col xxl={5} xl={6} lg={6} md={6} sm={12} className=" mt-xxl-0 mt-3">
                                                        <p className="mb-2 fs-15 fw-semibold">Strap Material</p>
                                                        <div className="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                            <input type="radio" className="btn-check" name="strap-material" id="strap1" defaultChecked />
                                                            <label className="btn btn-sm btn-outline-light text-default" htmlFor="strap1">Leather</label>
                                                            <input type="radio" className="btn-check" name="strap-material" id="strap2" />
                                                            <label className="btn btn-sm btn-outline-light text-default" htmlFor="strap2">Stainless steel</label>
                                                            <input type="radio" className="btn-check" name="strap-material" id="strap3" />
                                                            <label className="btn btn-sm btn-outline-light text-default" htmlFor="strap3">Synthetic</label>
                                                        </div>
                                                    </Col>
                                                </div>
                                                <div className="mb-4">
                                                    ...
                                                    <Row>
                                                        <Col xxl={6} xl={6} lg={6} md={6} sm={12}>
                                                            ...
                                                            <p className="mb-0 d-flex">
                                                                <Link className="color-1 product-colors selected" to="#">
                                                                    <i className="ri-checkbox-blank-circle-fill"></i>
                                                                </Link>
                                                                <Link className="color-2 product-colors" to="#">
                                                                    <i className="ri-checkbox-blank-circle-fill"></i>
                                                                </Link>
                                                                <Link className="color-3 product-colors" to="#">
                                                                    <i className="ri-checkbox-blank-circle-fill"></i>
                                                                </Link>
                                                                <Link className="color-4 product-colors" to="#">
                                                                    <i className="ri-checkbox-blank-circle-fill"></i>
                                                                </Link>
                                                                <Link className="color-5 product-colors" to="#">
                                                                    <i className="ri-checkbox-blank-circle-fill"></i>
                                                                </Link>
                                                            </p>
                                                        </Col>
                                                        <Col xxl={6} xl={6} lg={6} md={6} sm={12} className=" mt-md-0 mt-3">
                                                            <p className="fs-15 fw-semibold mb-2">Dial Size(in mm) :</p>
                                                            <p className="mb-0 d-flex">
                                                                <Link className="color-1 product-sizes selected" to="#">
                                                                    44
                                                                </Link>
                                                                <Link className="color-2 product-sizes" to="#">
                                                                    40
                                                                </Link>
                                                                <Link className="color-3 product-sizes" to="#">
                                                                    38
                                                                </Link>
                                                            </p>
                                                        </Col>
                                                ...
                                                <div className="mb-4">
                                                    <div className="row justify-content-center">
                                                        <Col xxl={4} xl={4} lg={4} sm={4} className="col-12">
                                                            <div className="ecommerce-assurance">
                                                                ...
                                                                <p className="fs-14 fw-semibold mb-0">Assured Quality</p>
                                                            </div>
                                                        </Col>
                                                        <Col xxl={4} xl={4} lg={4} sm={4} className="col-12 mt-sm-0 mt-3">
                                                            <div className="ecommerce-assurance">
                                                                <p className="mb-3">
                                                ...
                                                <div className="mb-0">
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xxl={8} xl={12} lg={12} sm={12} className="mt-xxl-0 mt-3">
                                        ...
                                        <Col xl={4} className="mt-xxl-0 mt-3">
                                            <div className="mb-5">
                                                <div className="offer-promotion mb-4">
                                                    <div className="d-xxl-flex d-lg-block d-sm-flex flex-wrap justify-content-between align-items-center">
                                                        <div className="text-warning">Use Code <span className="promotion-code fw-semibold">FIRBUY</span><Link className="fs-10 text-warning ms-1" to="#">T&C.</Link></div>
                                                        <div className="mt-sm-0 mt-2">
                                                            <span className="bg-warning-transparent text-default fs-12 offer-details mb-0">Get it for <span className="text-success fw-semibold">$1,099</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="mb-4">
                                                    <p className="text-danger mb-0 fs-16">Only 5 left in stock.</p>
                                                    <p className="mb-0 fs-12">Sold by <span className="text-primary me-1"><u>Regaltos PVT.LTD</u></span>and quality checked by <span className="text-primary"><u>Spruko Tchnologies</u>.</span></p>
                                                </div>
                                                <div className="mb-4">
                                                    <ul className="list-group">
                                                        <li className="list-group-item">
                                                            <div className="lh-1">
                                                                <span className="text-success fw-semibold fs-14 d-flex align-items-center"><i className="ti ti-discount-2 fs-18 me-1"></i>3 Available offers</span>
                                                            </div>
                                                        </li>
                                                        <li className="list-group-item">
                                                            <div className="fs-12 text-default">
                                                                <span className="text-success me-1 fw-semibold">Bank Offer:</span><span className="flex-fill">5% off upto 500 on min purchase of $999<Link to="#" className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                        <li className="list-group-item">
                                                            <div className="fs-12 text-default">
                                                                <span className="text-success me-1 fw-semibold">Emi:</span><span className="flex-fill">No cost emi on selected bank card on min purchase of $1,499<Link to="#" className="text-primary ms-1">View.</Link></span>
                                                            </div>
                                                        </li>
                                                        <Collapse in={open}>
                                                            <li className="list-group-item p-0">
                                                                <ul className="list-group" id="">
                                                                    <li className="list-group-item border-0 border-bottom">
                                                                        <div className="fs-12 text-default">
                                                                            <span className="text-success me-1 fw-semibold">Free Delivery:</span><span className="flex-fill">Free delivery on first order<Link to="#" className="text-primary ms-1">View.</Link></span>
                                                                        </div>
                                                                    </li>
                                                                    <li className="list-group-item border-0">
                                                                        <div className="fs-12 text-default">
                                                                            <span className="text-success me-1 fw-semibold">Promotion:</span><span className="flex-fill">Offer upto 30% on grosery on purchase of this item<Link to="#" className="text-primary ms-1">T&C.</Link></span>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                        ...
                                                        <li className="list-group-item border-top-0">
                                                            <Link className="text-success fs-12" data-bs-toggle="collapse" to="#offers-more" role="button" onClick={() => setOpen(!open)}
                                                                aria-controls="example-collapse-text"
                                                                aria-expanded={open}><u>More Offers</u></Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="mb-4">
                                                    <p className="mb-0 fw-semibold">Returns:</p>
                                                    <p className="fs-12 text-muted">Min 7 days return and exchange policy. Return Policies may vary based on products and promotions. For full details on our Returns Policies, please <Link to="#" className="text-primary">click here</Link>․</p>
                                                </div>
                                                <div className="alert alert-light mb-4 fs-12 text-muted" role="alert">
                                                    <Link to="#"><i className="ri-map-pin-line me-1 align-middle text-primary fs-15 d-inline-block"></i></Link>Select location to find out estimated delivery date
                                                </div>
                                                <div className="d-grid">
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/cart/`} className="btn btn-primary mb-2">Add To Cart</Link>
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/checkout/`} className="btn btn-success mb-2">Buy Now</Link>
                                                    <Link to={`${import.meta.env.BASE_URL}pages/ecommerce/wishlist/`} className="btn btn-light">Add To Wishlist</Link>
                                                </div>
                                            </div>
                                            <div className="text-center">
                                                <Link to="#">
                                                    <img src={ecommerceimg25} alt="" className="img-fluid rounded bg-light" />
                                                </Link>
                                            </div>
                                        </Col>
                                    </Row>
