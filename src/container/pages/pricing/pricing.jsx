        ...
        <Fragment>
            ...
            <Row className="mb-5">
                <Tab.Container defaultActiveKey="one">
                    <Col xl={12}>
                        <h5 className="fw-semibold text-center"> Simple Pricing For Everyone </h5>
                        <p className="text-muted text-center">Choose plan that suits best for your business needs, Our plans scales with you based on your needs</p>
                        <div className="d-flex justify-content-center mb-4">
                            <Nav className="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab1" role="tablist">
                                <Nav.Item>
                                    <Nav.Link eventKey="one" id="pricing-monthly1">Monthly</Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="two" id="pricing-yearly1">Yearly</Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </div>
                    </Col>
                    <Col xl={12}>
                        <Tab.Content className="tab-content" id="myTabContent1">
                            <Tab.Pane eventKey="one" className="p-0 border-0" id="pricing-monthly1-pane"
                                ...
                                <Row>
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$0<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub></div>
                                                    ...
                                                    <ul className="list-unstyled mb-0">
                                                        ...
                                                        <li className="d-grid">
                                                            <Button variant='light' className="btn  btn-wave">Choose Plan</Button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Card.Body>
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$149<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3"><u>Billed Monthly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                                    ...
                                    <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                                        <Card className="custom-card overflow-hidden border border-primary">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$1,299<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3 text-dark"><u>Billed Monthly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                                                                <i className="ri-checkbox-circle-line fs-15 text-success"></i>
                                                        ...
                                                        <li className="d-grid">
                                                            <Button variant='primary' className="btn  btn-wave">Choose Plan</Button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Card.Body>
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$7,999<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Month</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3"><u>Billed Monthly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                                                            ...
                                                            <span>
                                                                <strong className="me-1 d-inline-block">20 Free</strong>Websites
                                                            </span>
                                                        </li>
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                                                            ...
                                                            <span>
                                                                <strong className="me-1 d-inline-block">30 GB</strong>Hard disk storage
                                                            </span>
                                                        </li>
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                                                            ...
                                                            <span>
                                                                <strong className="me-1 d-inline-block">5 Year</strong>Email support
                                                            </span>
                                                        </li>
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                                                            ...
                                                            <span>
                                                                <strong className="me-1 d-inline-block">50</strong>Licenses
                                                            </span>
                                                        </li>
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                            ...
                            <Tab.Pane eventKey="two" className="p-0 border-0" id="pricing-yearly1-pane"
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$0<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Year</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$1,799<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Year</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3"><u>Billed yearly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                                        ...
                                        <Card className="custom-card overflow-hidden border border-primary">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$11,999<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Year</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3 text-dark"><u>Billed yearly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                                                            <span className="me-2">
                                                                <i className="ri-checkbox-circle-line fs-15 text-success"></i>
                                        ...
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className="card-body p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="fs-25 fw-bold mb-1">$83,999<sub className="text-muted fw-semibold fs-11 ms-1">/ Per Year</sub></div>
                                                    <div className="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</div>
                                                    <div className="fs-12 mb-3"><u>Billed yearly</u></div>
                                                    <ul className="list-unstyled mb-0">
                                                        <li className="d-flex align-items-center mb-3">
                        ...
                        <Tab.Container defaultActiveKey="one">
                            ...
                            <div className="d-flex justify-content-center mb-4">
                                <Nav className="nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab" role="tablist">
                                    <Nav.Item>
                                        <Nav.Link eventKey="one" id="pricing-monthly">Monthly</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="two" id="pricing-yearly">Yearly</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </div>
                            <Card className="custom-card overflow-hidden">
                                <Card.Body className="p-0">
                                    <Tab.Content id="myTabContent">
                                        <Tab.Pane eventKey="one" className="p-0 border-bottom-0" id="pricing-monthly-pane"
                                            role="tabpanel" aria-labelledby="pricing-monthly" tabIndex={0}>
                                            <Row>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed pe-0">
                                                    <div className="p-4">
                                                        ...
                                                        <div className="d-grid">
                                                            <Button variant='primary-light' className="btn btn-wave">Get Started</Button>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed px-0">
                                                    <div className="p-4">
                                                ...
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="ps-0">
                                                    <div className="p-4 pricing-offer overflow-hidden">
                                                        ...
                                                        <div className="d-grid">
                                                            <Button variant='primary' className="btn btn-wave">Get Started</Button>
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="two" className="p-0 border-bottom-0" id="pricing-yearly-pane"
            ...
            <Row className="row justify-content-center">
                <Col xxl={8} xl={12} md={12} lg={12} sm={12}>
                    <div className="container-lg">
                        <div className="row justify-content-center">
                            <Col xl={9}>
                                <h5 className="fw-semibold text-center"> Pricing Plans </h5>
                                <p className="text-muted text-center mb-4">Select best plans that fits your needs for your business growth,plans are flexible with the enterprise.Familiarize with the payment plans below</p>
                            </Col>
                        </div>
                                ...
                                <div className="table-responsive">
                                    <Table bordered className="table  text-nowrap">
                                        <thead>
                                            <tr>
                                                <th scope="col">
                                                    <span className="fs-15 fw-semibold">Chek Our Plans</span>
                                                </th>
                                                <th scope="col" className="pricing-basic">
                                                    <span className="fs-15 fw-semibold">Basic</span>
                                                </th>
                                                <th scope="col" className="pricing-pro">
                                                    <span className="fs-15 fw-semibold">Pro</span>
                                                </th>
                                                <th scope="col" className="pricing-premium">
                                                    <span className="fs-15 fw-semibold">Premium</span>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr className="text-center bg-light">
                                                <td colSpan={4}>
                                                    <span className="fs-14 fw-semibold">Pricing</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">
                                                    <span className="fw-bold fs-14">Net Price</span>
                                                </th>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$99</span>
                                                </td>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$299</span>
                                                </td>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$499</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">
                                                    <span className="fw-bold fs-14">Annual
                                                        Subscription</span>
                                                </th>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$1,199</span>
                                                </td>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$3,499</span>
                                                </td>
                                                <td>
                                                    <span className="fs-18 fw-semibold text-dark">$5,499</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">
                                                    <span className="fw-bold fs-14">Activation
                                                        Charges</span>
                                                </th>
                                                <td>
                                                    <span className="fw-semibold">0% + $99</span>
                                                </td>
                                                <td>
                                                    <span className="fw-semibold">5% + $149</span>
                                                </td>
                                                <td>
                                                    <span className="fw-semibold">10% + $259</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td className="border-bottom-0"></td>
                                                <td className="border-bottom-0">
                                                    <Button variant='primary' className="btn  btn-wave">Choose
                                                        Plan</Button>
                                                </td>
                                                <td className="border-bottom-0">
                                                    <Button variant='primary' className="btn btn-wave">Choose
