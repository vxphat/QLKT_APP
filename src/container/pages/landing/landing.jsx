                ...
                <div className="container p-0">
                    <div className="main-sidebar">
                        ...
                        <nav className="main-menu-container nav nav-pills sub-open">
                            ...
                            <div className="slide-left" id="slide-left" onClick={() => toggleNavigation()}
                            ><svg xmlns="http://www.w3.org/2000/svg" fill="#7b8191" width="24" height="24" viewBox="0 0 24 24"> <path d="M13.293 6.293 7.586 12l5.707 5.707 1.414-1.414L10.414 12l4.293-4.293z"></path> </svg></div>
                            ...
                            <div className="d-lg-flex d-none">
                                <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                    ...
                                    <Button variant='' className="btn btn-wave btn-icon btn-light switcher-icon" data-bs-toggle="offcanvas" onClick={() => Switchericon()} data-bs-target="#switcher-canvas">
                                        <i className="ri-settings-3-line"></i>
                                    </Button>
                                </div>
                            </div>
            ...
            <div className="main-content landing-main" onClick={handleClick}>
                            ...
                            <Row>
                                <Col xxl={7} xl={7} lg={7} md={8}>
                                    <div className="py-lg-5">
                                        <div className="mb-3">
                                            <h5 className="fw-semibold text-fixed-white op-9">BRILLIANCE IN EXECUTION</h5>
                                        </div>
                                        <p className="landing-banner-heading mb-3">Your sure stop place for best theme ends here with <span className="text-secondary">YNEX !</span></p>
                                        <div className="fs-16 mb-5 text-fixed-white op-7">ynex - Now you can use this admin template to design stunning dashboards that will wow your target viewers or users to no end.</div>
                                        <Link to={`${import.meta.env.BASE_URL}dashboards/crm/`} className="m-1 btn btn-primary">
                                            View Demos
                ...
                <section className="section section-bg " id="statistics">
                    <div className="container text-center position-relative">
                        ...
                        <h3 className="fw-semibold mb-2">More than 120+ projects completed.</h3>
                        <div className="row justify-content-center">
                            <Col xl={7} className="col-xl-7">
                                <p className="text-muted fs-15 mb-5 fw-normal">We are proud to have top class clients and customers,which motivates us to work more on projects.</p>
                            </Col>
                        </div>
                ...
                <section className="section " id="about">
                    <div className="container text-center">
                        <p className="fs-12 fw-semibold text-success mb-1"><span className="landing-section-heading">CUSTOMIZATION</span></p>
                        <h3 className="fw-semibold mb-2">Designed with precision and well documented</h3>
                        <div className="row justify-content-center">
                            <div className="col-xl-7">
                                <p className="text-muted fs-15 mb-3 fw-normal">ynex comes with multiple customization options that are very easy to implement.</p>
                            </div>
                        </div>
                        <div className="row justify-content-between align-items-center">
                            ...
                            <div className="col-xxl-6 col-xl-6 col-lg-6 pt-5 pb-0 px-lg-2 px-5 text-start">
                                <h5 className="text-lg-start fw-semibold mb-0">Present your awesome product</h5>
                                <p className=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur adipisicing elit</p>
                                <Row>
                                    <div className="col-12 col-md-12">
                                        <div className="d-flex">
                                            ...
                                            <div className="ms-2">
                                                <h6 className="fw-semibold mb-0">Can Switch Easily From Vertical to HorizontalMenu.</h6>
                                                <p className=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 col-md-12">
                                        <div className="d-flex">
                                            ...
                                            <div className="ms-2">
                                                <h6 className="fw-semibold mb-0">Switch Easily From One Color to Another Color style</h6>
                                                <p className=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 col-md-12">
                                        <div className="d-flex">
                                            ...
                                            <div className="ms-2">
                                                <h6 className="fw-semibold mb-0">Switch Easily From Fixed to Scrollable Layout.</h6>
                                                <p className=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <section className="section section-bg " id="our-mission">
                    <div className="container text-center">
                        ...
                        <div className="row justify-content-center mb-5">
                            <div className="col-xl-7">
                                <p className="text-muted fs-15 fw-normal">Our mission is to make web design easy, so you can focus on building your brand.</p>
                            </div>
                        </div>
                        <Row>
                                    ...
                                    <Card.Body>
                                        <div className="align-items-top">
                                            ...
                                            <div>
                                                ...
                                                <p className="mb-0 text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman code Lorem ipsum, dolor sit amet consectetur adipisicing elit</p>
                                            </div>
                                        </div>
                                    </Card.Body>
                                </Card>
                ...
                <section className="section landing-Features" id="features">
                    <div className="container text-center">
                        ...
                        <h2 className="fw-semibold mb-2 text-fixed-white ">Features Used in YNEX</h2>
                        <div className="row justify-content-center">
                            <div className="col-xl-7">
                                <p className="text-fixed-white op-8 fs-15 mb-3 fw-normal">Some of the reviews our clients gave which brings motivation to work for future projects.</p>
                            </div>
                        </div>
                                ...
                                <div className="">
                                    <div className="feature-logos mt-sm-5 flex-wrap" >
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={reactimg} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">React</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={tsimg} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">Typescript</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={Rb} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">ReactBootstrap</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={web6} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">NPM</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={yarnimg} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">Yarn</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={web4} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">Sass</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={cssimg} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">Css</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={muiimg} alt="image" className="featur-icon" />
                                            <h5 className="mt-3 text-fixed-white ">Mui</h5>
                                        </div>
                                        <div className="ms-sm-5 ms-2 text-center">
                                            <img src={web5} alt="image" className="featur-icon" />
                                                ...
                                                <Card.Body>
                                                    <div className="d-flex align-items-center mb-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="mb-0 fs-10 fw-semibold text-muted">CEO OF EMPIRO</p>
                                                        </div>
                                                    </div>
                                                    <div className="mb-3">
                                                        <span className="text-muted">- Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum autem quaerat distinctio  --</span>
                ...
                <section className="section  section-bg" id="team">
                    <div className="container text-center">
                            ...
                            <Col xxl={3} xl={3} lg={6} md={6} sm={12}>
                                <Card className="custom-card text-center team-card ">
                                    <Card.Body className="card-body p-5">
                                        ...
                                        <div className="mt-2">
                                            <Button variant='' href={`${import.meta.env.BASE_URL}pages/profile`} target="_blank" className="btn btn-light">View profile</Button>
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
                        ...
                        <div className="mt-5">
                            <Button variant='' className="btn btn-primary">View All</Button>
                        </div>
                    </div>
                </section>
                <section className="section  " id="pricing">
                    <div className="container text-center">
                        <p className="fs-12 fw-semibold text-success mb-1"><span className="landing-section-heading">PRICING</span></p>
                        <h3 className="fw-semibold mb-2">ynex comes with most affordable pricing range.</h3>
                        <div className="row justify-content-center">
                            <Col xl={9}>
                                <p className="text-muted fs-15 mb-5 fw-normal">Our plans are most affordable and are mainly placed by focussing every category in the sector even basic plan helps better.</p>
                            </Col>
                        </div>
                        <Tab.Container defaultActiveKey="1">
                            <div className="d-flex justify-content-center mb-4">
                                <Nav className="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab" role="tablist">
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="1" className="" id="pricing-monthly" data-bs-toggle="tab"
                                            data-bs-target="#pricing-monthly-pane" type="button" role="tab"
                                            aria-controls="pricing-monthly-pane" aria-selected="true">Monthly</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item className="" role="presentation">
                                        <Nav.Link eventKey="2" className="" id="pricing-yearly" data-bs-toggle="tab"
                                            data-bs-target="#pricing-yearly-pane" type="button" role="tab"
                                            aria-controls="pricing-yearly-pane" aria-selected="false">Yearly</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </div>
                            <Card className="custom-card overflow-hidden shadow-none">
                                <Card.Body className="card-body p-0">
                                    <Tab.Content className="" id="myTabContent">
                                        <Tab.Pane eventKey="1" className="p-0" id="pricing-monthly-pane"
                                            role="tabpanel" aria-labelledby="pricing-monthly" tabIndex={0}>
                                            <Row>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed">
                                                    <div className="p-4">
                                                        ...
                                                        <div className="py-4 d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div className="text-end ms-5">
                                                                ...
                                                                <p className="text-muted fs-11 fw-semibold mb-0">per month</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="d-grid">
                                                            <Button variant='' className="btn btn-primary-light btn-wave">Get Started</Button>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed">
                                                ...
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12}>
                                                    <div className="p-4 pricing-offer overflow-hidden">
                                                        ...
                                                        <div className="py-4 d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div className="text-end ms-5">
                                                                <p className="fs-25 fw-semibold mb-0 text-primary">$1,299</p>
                                                                <p className="text-muted fs-11 fw-semibold mb-0">per month</p>
                                                            </div>
                                                        </div>
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                        ...
                                                        <div className="d-grid">
                                                            <Button variant='' className="btn btn-primary btn-wave shadow">Get Started</Button>
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="2" className="p-0 border-bottom-0" id="pricing-yearly-pane"
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        <div className="py-4 d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div className="text-end ms-5">
                                                                ...
                                                                <p className="text-muted fs-11 fw-semibold mb-0">per year</p>
                                                            </div>
                                                        </div>
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            <li className="mb-3">
                                                ...
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12}>
                                                    <div className="p-4 pricing-offer overflow-hidden">
                                                        ...
                                                        <div className="py-4 d-flex align-items-center justify-content-center">
                                                            ...
                                                            <div className="text-end ms-5">
                                                                <p className="fs-25 fw-semibold mb-0 text-primary">$11,499</p>
                                                                <p className="text-muted fs-11 fw-semibold mb-0">per year</p>
                                                            </div>
                                                        </div>
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                        ...
                        <div className="row text-start">
                            <Col xl={12}>
                                <div className="row gy-2">
                                    <Col xl={6}>
                                        <Accordion defaultActiveKey="1" className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ1">
                                            <Accordion.Item eventKey='1' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1One">
                                            ...
                                            <Accordion.Item eventKey='2' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1Two">
                                            ...
                                            <Accordion.Item eventKey='3' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1Three">
                                            ...
                                            <Accordion.Item eventKey='4' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1Four">
                                            ...
                                            <Accordion.Item eventKey='5' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1Five">
                                            ...
                                            <Accordion.Item eventKey='6' className="">
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon1Six">
                                    ...
                                    <Col xl={6}>
                                        <Accordion defaultActiveKey="6" className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ2">
                                            <Accordion.Item eventKey='1'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2Five">
                                                    General Terms & Conditions (GTC)
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                                            ...
                                            <Accordion.Item eventKey='2'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2Six">
                                                    Do I need to create an account to make an order?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                                            ...
                                            <Accordion.Item eventKey='3'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2One">
                                                    Where can I subscribe to your newsletter?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                                            ...
                                            <Accordion.Item eventKey='4'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2Two">
                                                    Where can in edit my address?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                                            ...
                                            <Accordion.Item eventKey='5'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2Three">
                                                    What are your opening hours?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                                            ...
                                            <Accordion.Item eventKey='6'>
                                                <Accordion.Header as="h2" className="accordion-header" id="headingcustomicon2Four">
                                                    Do I have the right to return an item?
                                                </Accordion.Header>
                                                <Accordion.Body>
                                                    <strong>This is the first item's accordion body.</strong> It is shown by
                            ...
                            <Col xl={4}>
                                <div className="px-4">
                                    <p className="fw-semibold mb-3 text-fixed-white">
                                        <Link to={`${import.meta.env.BASE_URL}dashboards/crm/`}><img src={desktopdark} alt="" /></Link></p>
