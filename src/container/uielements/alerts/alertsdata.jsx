import face1 from "../../../assets/images/faces/3.jpg";
import face2 from "../../../assets/images/faces/5.jpg";
import face3 from "../../../assets/images/faces/8.jpg";
import face4 from "../../../assets/images/faces/11.jpg";
import face5 from "../../../assets/images/faces/13.jpg";
import face6 from "../../../assets/images/faces/10.jpg";
import face7 from "../../../assets/images/faces/15.jpg";
import face8 from "../../../assets/images/faces/14.jpg";
...
export const Imagealerts= [
  { id: 1, src1: face1, color: 'primary' , class:''},
  { id: 2, src1: face2, color: 'secondary' , class:''},
  { id: 3, src1: face3, color: 'warning' , class:''},
  { id: 4, src1: face4, color: 'danger' , class:''},
  { id: 5, src1: face5, color: 'info' , class:''},
  { id: 6, src1: face6, color: 'light' , class:''},
  { id: 7, src1: face7, color: 'dark' , class:'text-muted'},
];

export const avatarsizealert = [
  { id: 1, src1: face1, color: 'primary', class: 'xs' , class1:''},
  { id: 2, src1: face2, color: 'secondary', class: 'sm' , class1:''},
  { id: 3, src1: face3, color: 'warning', class: '' , class1:''},
  { id: 4, src1: face4, color: 'danger', class: 'md' , class1:''},
  { id: 5, src1: face5, color: 'info', class: 'lg' , class1:''},
  { id: 6, src1: face8, color: 'dark', class: 'xl' , class1:'text-muted'},
];
