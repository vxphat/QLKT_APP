                ...
                <Col xl={6}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ListGroup>
                                {ContextualButtons.map((idx) => (
                                    <ListGroup.Item variant={idx.class} action className="list-group-item list-group-item-action" key={Math.random()}>{idx.text}</ListGroup.Item>
                                ))}
                            </ListGroup>
                        </Card.Body>
                            ...
                            <code>{` <ListGroup as="ul">
{ContextualButtons.map((idx)=>(
    <ListGroup.Item variant={idx.class} action className="list-group-item list-group-item-action">{idx.text}</ListGroup.Item>
))}</ListGroup>`}</code></pre>
                        </Collapse>
                    </Card>
                </Col>
