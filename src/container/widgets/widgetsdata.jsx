...
//GLM
export class GLM extends Component {
  constructor(props) {
    super(props);
...
export const Salesdata = [
  { id: 1, icon: 'ri-briefcase-2-line fs-16', color: 'primary', text1: 'Total Sales', text2: '15,800', badge: '+25.8%', bg: 'success-transparent' },
  { id: 2, icon: 'ri-bill-line fs-16', color: 'secondary', text1: 'Total Tax', text2: '$12,650', badge: '+12.2%', bg: 'success-transparent' },
  { id: 3, icon: 'ri-wallet-2-line fs-16', color: 'success', text1: 'Total Income', text2: '$14,800', badge: '+7.45%', bg: 'success-transparent' },
  { id: 4, icon: 'ri-line-chart-line fs-16', color: 'info', text1: 'Total Expenses', text2: '$7,566', badge: '-3.21%', bg: 'danger-transparent' },
  { id: 5, icon: 'ri-money-dollar-box-line fs-16', color: 'warning', text1: 'Sales Profit', text2: '$7,474', badge: '+36.03%', bg: 'success-transparent' },
  { id: 6, icon: 'ri-profile-line fs-16', color: 'danger', text1: 'Opex Ratio', text2: '32%', badge: '+0.89%', bg: 'success-transparent' },
];

export const Trafficsources= [
  { id: 1, icon: 'ri-google-fill fs-18 text-fixed-white', color: '', text1: 'Google', text2: '23,379', text3: '16,890', now: 34 },
  { id: 2, icon: 'ri-safari-line fs-18 text-fixed-white', color: '', text1: 'Safari', text2: '78,973', text3: '29,906', now: 58 },
  { id: 3, icon: 'ri-opera-fill fs-18 text-fixed-white', color: '', text1: 'Opera', text2: '12,457', text3: '8,674', now: 62 },
  { id: 4, icon: 'ri-edge-fill fs-18 text-fixed-white', color: '', text1: 'Edge', text2: '8,570', text3: '4,980', now: 71 },
  { id: 5, icon: 'ri-firefox-fill fs-18 text-fixed-white', color: '', text1: 'Firefox', text2: '6,135', text3: '4,436', now: 48 },
  { id: 6, icon: 'ri-ubuntu-fill fs-18 text-fixed-white', color: '', text1: 'Ubuntu', text2: '4,789', text3: '2,447', now: 28 },
];
//
//Applicants
