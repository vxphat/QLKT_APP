                ...
                <Col xl={9}>
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            ...
                            <div>
                                <span className="badge bg-light text-default me-1">UI/Ux</span>
                                <span className="badge bg-light text-default me-1">JavaScript</span>
                                <span className="badge bg-light text-default me-1">Responsive Design</span>
                                <span className="badge bg-light text-default me-1">Web Accessibility</span>
                                <span className="badge bg-light text-default me-1">Front-End Build Tools</span>
                                <span className="badge bg-light text-default me-1">RESTful APIs</span>
                                <span className="badge bg-light text-default me-1">Performance Testing</span>
                                <span className="badge bg-light text-default me-1">Angular</span>
                                <span className="badge bg-light text-default me-1">Vue.js</span>
                            </div>
                        </Card.Body>
