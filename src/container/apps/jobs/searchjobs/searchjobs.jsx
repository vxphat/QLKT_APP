...
const Searchjobs = ({ local_varaiable }) => {
    ...
    return (
        <Fragment>
            <Pageheader title="Job Search" heading="Jobs" active="Job Search" />
                        ...
                        <Card className="custom-card">
                            <Card.Body className="p-3">
                                <div className="row align-items-center">
                                    ...
                                    <Col lg={4} className="text-sm-end mt-3 mt-sm-0">
                                        <div className="btn-group">
                                            <Dropdown>
                                                ...
                                                <Dropdown.Menu>
                                                    ...
                                                    <Dropdown.Item href="#">Best Rated</Dropdown.Item>
                                                </Dropdown.Menu>
                                            </Dropdown>
                                        </div>
                                    </Col>
                            ...
                            <Card.Body className="p-0">
                                <div className="p-4 border-bottom">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link" to="#category-more" onClick={() => setOpen(!open)}
                                ...
                                <div className="p-4 border-bottom">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">512</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">2,186</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">734</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            <Form.Check type="checkbox" value="" id="j-4" />
                                            <label className="form-check-label" htmlFor="j-4">
                                                Freelancer
                                            </label>
                                            <Badge bg="light" className="text-default fw-500 float-end">16</Badge>
                                        </div>
                                        <div className="form-check">
                                            <Form.Check type="checkbox" value="" id="j-5" />
                                            <label className="form-check-label" htmlFor="j-5">
                                                Remote Job
                                            </label>
                                            <Badge bg="light" className="text-default fw-500 float-end">1,432</Badge>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-4 border-bottom">
                                ...
                                <div className="p-4 border-bottom">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">16,563</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">15,234</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            <Form.Check type="checkbox" value="" id="q-3" />
                                            <label className="form-check-label" htmlFor="q-3">
                                                12th Pass and Above
                                            </label>
                                            <Badge bg="light" className="text-default fw-500 float-end">6,278</Badge>
                                        </div>
                                        <div className="form-check mb-2">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">4,531</Badge>
                                        </div>
                                        <div className="form-check">
                                            ...
                                            <Badge bg="light" className="text-default fw-500 float-end">2,405</Badge>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-4 border-bottom">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        ...
                                        <div className="form-check mb-2">
                                            <Form.Check type="checkbox" value="" id="e-3" defaultChecked />
                                        ...
                                        <div className="form-check">
                                            <Form.Check type="checkbox" value="" id="e-4" defaultChecked />
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="px-2 py-3 pb-0">
                                        ...
                                        <Link className="ecommerce-more-link" data-bs-toggle="collapse" to="#sizes-more" aria-expanded={open1}
                            ...
                            <Card.Body>
                                <div className="btn-list float-end">
                                    ...
                                    <OverlayTrigger placement="top" overlay={<Tooltip>Featured Jobs</Tooltip>}>
                                        <Link to="#" className="avatar avatar-rounded avatar-sm bg-warning-transparent"
                                            aria-label="Featured Jobs" data-bs-original-title="Featured Jobs"><span><i className="bi bi-star-fill"></i></span></Link>
                                    </OverlayTrigger>
                                ...
                                <div className="popular-tags mb-3">
                                    <Badge bg="light" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Badge>
                                    <Badge bg="light" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-briefcase text-muted me-1"></i> 13 Openings</Badge>
                                    <Badge bg="light" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-mortarboard text-muted me-1"></i> Graduate</Badge>
                                    <Badge bg="light" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Badge>
                                    <Badge bg="light" className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-moon-stars text-muted me-1"></i> flexible-shift</Badge>
                                </div>
                                <div className="d-flex justify-content-between">
                                    <h6 className="fw-semibold mb-0">$25,000 - $35,000</h6>
                                    <Link to="#" className="text-primary fw-semibold fs-14">
                                        Apply Now <i className="fe fe-arrow-right ms-1 d-inline-flex"></i>
                                    </Link>
                                </div>
                            </Card.Body>
                        </Card>
