...
import image13 from "../../../../assets/images/nft-images/13.png";
import image15 from "../../../../assets/images/nft-images/15.png";
...
import { Progressdata, Tabledata } from './nftdetailsdata';
...
const Nftdetails= () => {
    ...
    return(
  <Fragment>
                <Pageheader title="NFT Details" heading="NFT" active="NFT Details" />
                <div className="row justify-content-center">
                    <Col xl={10}>
                        <Card className="custom-card overflow-hidden">
                            <Card.Body>
                                <span className="nft-details-auction-time shadow">24hrs : 32mins : 11sec</span>
                                        ...
                                        <Row>
                                            <Col xxl={12} sm={12}  className="mb-md-5 mb-3">
                                             <Swiper
                                                            ...
                                                            >
                                                                <SwiperSlide>
                                                                <img className="img-fluid" src={image32} alt="img"/>
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                <img className="img-fluid" src={image31} alt="img"/>
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                <img className="img-fluid" src={image30} alt="img"/>
                                                                </SwiperSlide>
                                                                <SwiperSlide>
                                                                <img className="img-fluid" src={image33} alt="img"/>
                                                                </SwiperSlide>
                                                            </Swiper>
                                            ...
                                            <Col xxl={12} sm={12 }className=" d-md-block d-none">
                                                <p className="fs-15 fw-semibold mb-2">Featured NFT's :</p>
                                                <div className="table-responsive">
                                                    <Table className="table table-bordered text-nowrap">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td className="d-grid">
                                                                    <Button variant='primary-light' className="">View All NFT's</Button>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </Table>
                                    ...
                                    <Col xxl={8} xl={12}>
                                        <div className="row gx-5">
                                            <Col xl={12}  className=" mt-xxl-0 mt-3">
                                                <div>
                                                    <p className="fs-18 fw-semibold mb-0">Digital Dream Space - NFT Digital Art</p>
                                                    <p className="fs-18 mb-4">
                                                        <i className="ri-heart-3-fill text-danger align-middle"></i>
                                                        <span className="fw-semibold text-muted"><Link className="text-info fs-14" to="#"> (2.4k Likes) </Link></span>
                                                    </p>
                                                    <div className="row mb-4">
                                                        <Col xxl={3} xl={12}>
                                                            <p className="mb-1 lh-1 fs-11 text-success fw-semibold">Special Offer</p>
                                                            <p className="mb-1"><span className="h3"><span className="avatar avatar-sm avatar-rounded p-1 bg-light me-2">
                                                                <img src={crypto} alt=""/></span>1.299<sup className="fs-14">.00</sup></span><span className="ms-3 badge bg-danger-transparent">50% Off</span></p>
                                                            <p className="mb-0 text-muted fs-12">M.R.P-<s>ETH2,599.00</s></p>
                                                        </Col>
                                                        <Col xxl={4} xl={6} lg={6} md={6} sm={12} className="mt-xxl-0 mt-3">
                                                            <p className="mb-2 fs-15 fw-semibold">Creator</p>
                                                            <div className="d-flex align-items-center fw-semibold">
                                                                <span className="avatar avatar-xs avatar-rounded lh-1 me-1"><img src={face9} alt=""/></span>
                                                                Json Taylor
                                                            </div>
                                                        </Col>
                                                        <Col xxl={5} xl={6} lg={6} md={6} sm={12} className="mt-xxl-0 mt-3">
                                                            <p className="mb-2 fs-15 fw-semibold">Published</p>
                                                            <span className="d-block fw-semibold">24, Jul 2023 - 12:45PM</span>
                                                        </Col>
                                                    </div>
                                                    <div className="mb-4">
                                                        ...
                                                        <div className="row justify-content-center">
                                                            <Col xxl={4} xl={4} lg={4} md={4} sm={4} className="col-12">
                                                                <div className="ecommerce-assurance">
                                                                    ...
                                                                    <p className="fs-14 fw-semibold mb-0">Featured NFT</p>
                                                                </div>
                                                            </Col>
                                                            ...
                                                            <Col xxl={4} xl={12} lg={12} md={12} sm={12}>
                                                                <div className="d-flex align-items-top mb-3">
                                                                    ...
                                                                    <div className="lh-1">
                                                                        ...
                                                                        <p className="mb-0 text-muted fs-11">Based on (23) ratings</p>
                                                                    </div>
                                                                </div>
                                                                {Progressdata.map((idx)=>(
                                                                <div className="d-flex align-items-center mb-3" key={Math.random()}>
                                                                    <div className="fs-12 me-2 fw-semibold">{idx.text1}<i className="ri-star-fill fs-10"></i></div>
                                                                    <ProgressBar variant={idx.color} now={idx.now} className='progress progress-xs flex-fill' />
                                                                    <div className="text-muted ms-2 fs-12">({idx.text2})</div>
                                                                </div>
                                                                ))}
                                                            </Col>
                                                            <Col xxl={8} xl={12} lg={12} md={12} sm={12} className="mt-xxl-0 mt-3">
                                                                <div className="border p-3">
                                                                    <div className="d-sm-flex d-block align-items-top mb-3">
                                                                        <div className="d-flex flex-fill">
                                                                            ...
                                                                            <div className="lh-1 me-2">
                                                                                ...
                                                                                <div className="mb-1">
                                                                                    <i className="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i className="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i className="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i className="ri-star-fill align-middle text-warning align-middle fs-12"></i>
                                                                                    <i className="ri-star-line text-warning align-middle fs-12"></i>
                                                                                </div>
                                                                    ...
                                                                    <div className="ps-sm-4 ps-0 mb-3">
                                                                        <p className="fw-semibold mb-1 ps-2">Truely amazing NFT&#128512;</p>
                                                                        <p className="mb-0 fs-12 text-muted ps-2">Digital Dreamspace is a truly captivating NFT that takes you on an unforgettable journey. The artwork's vivid colors and ethereal elements create a sense of tranquility and wonder </p>
                                                                    </div>
                                                                        ...
                                                                        <Row>
                                                                            <Col xl={6}>
                                                                                <div className="products-review-images">
                                                                                    <Link to="#">
                                                                                        <img src={image13} alt="" className="me-2"/>
                                                                                    </Link>
                                                                                    <Link to="#">
                                                                                        <img src={image15} alt=""/>
                                                                                    </Link>
